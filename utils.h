...
/*-----------------------------------------------------------------------------
 *  computes transmission probability TODO: fix this header
 *-----------------------------------------------------------------------------*/
void trans_functor(person &p)
{
    ;    
}
 ...
 * =====================================================================================
 */
bool inline  verify_sex_age(person &p, char sex, float lower, float higher)
{
...
void print_prevalence(list<person> &susceptible, list<person> &infected)
{
    ...
    cout << "\ninfected 15-49: " << num_infected << endl;
    cout << "susceptible 15-49: " << num_susceptible << endl;
